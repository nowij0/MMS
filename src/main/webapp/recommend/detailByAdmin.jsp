...
const del = () => {
	location.href = "${pageContext.request.contextPath }/recommend/admindelete.do?recSeq=${vo.recSeq}";
}</script>
...
<body style="background-image: url('../images/body-bg.jpg');">
   ...
   <main class="flex-container">
      ...
      <table border="1">
       <tr>
       <th colspan ="2"><a href="${pageContext.request.contextPath }/recommend/admin.do" style = "float:right;color:black" >목록으로 돌아가기</a></th>
      </tr>
      <tr>
	  ...
	  <tr>
	    <th>조회수</th><td style = "text-align:left">${vo.cnt }</td></tr>
	 	<tr><th>삭제</th>
		<td>
			<input type="button" value="삭제" onclick="del()" id ="btn1" style ="float:left"></td></tr>
      </table>
