...
<body style="background-image: url('../images/body-bg.jpg');">
	<header class="flex-container">
      ...
      <tr>
      	<th>글내용</th><td><textarea rows ="20" cols ="50" name ="content" style ="float:left;height:100px" placeholder="${vo.content }"></textarea></td></tr>
      <tr><th>이미지</th>
	  ...
	  <th>조회수</th><td style = "text-align:left">${vo.cnt }</td>
	  	...
	  	<c:if test="${sessionScope.loginId == vo.writer }">
	 	<tr><th>수정/삭제</th>
		<td><input type="submit" value="수정완료" id = "btn1" style ="float:left"> 
			<input type="button" value="삭제" id = "btn2" onclick="del(${vo.recSeq})" style ="float:left"></td></tr>
		</c:if>	
      </table>
